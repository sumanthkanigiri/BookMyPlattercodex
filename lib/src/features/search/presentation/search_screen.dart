...
class SearchScreen extends ConsumerStatefulWidget {
  const SearchScreen({this.initialCategoryId, this.initialQuery = '', super.key});
...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  late final SearchController searchController = SearchController()..text = widget.initialQuery;
  Timer? debounce;
  late String query = widget.initialQuery.trim();
  String? packageType;
  String? eventType;
