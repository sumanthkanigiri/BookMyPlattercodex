    ...
    return Title(
      ...
      child: RefreshIndicator(
        ...
        child: CustomScrollView(slivers: [
          SliverToBoxAdapter(child: _Hero(banners: banners)),
          SliverToBoxAdapter(
            child: _Section(
          ...
          SliverToBoxAdapter(child: _PackageSection(title: 'Popular packages', packages: packages)),
...
class _Hero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SizedBox(
        ...
        child: banners.when(
          ...
          error: (error, _) => _ErrorPanel(message: 'Promotions could not be loaded', onRetry: null),
          data: (items) {
...
class _PackageSection extends StatelessWidget {
  const _PackageSection({required this.title, required this.packages});
  final String title;
  ...
  Widget build(BuildContext context) => _Section(
        ...
        child: packages.when(
          loading: () => const _PackageSkeleton(),
          error: (error, _) => const _ErrorPanel(message: 'Packages could not be loaded', onRetry: null),
