...
class AdminShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final paths = fullAccess ? const ['/dashboard', '/enterprise', '/events', '/orders', '/crm', '/catalog', '/operations', '/management'] : const ['/operations'];
    final destinations = fullAccess
        ? const [NavigationRailDestination(icon: Icon(Icons.dashboard_outlined), selectedIcon: Icon(Icons.dashboard), label: Text('Dashboard')), NavigationRailDestination(icon: Icon(Icons.hub_outlined), selectedIcon: Icon(Icons.hub), label: Text('ERP')), NavigationRailDestination(icon: Icon(Icons.event_note_outlined), selectedIcon: Icon(Icons.event_note), label: Text('Events')), NavigationRailDestination(icon: Icon(Icons.receipt_long_outlined), selectedIcon: Icon(Icons.receipt_long), label: Text('Orders')), NavigationRailDestination(icon: Icon(Icons.groups_outlined), selectedIcon: Icon(Icons.groups), label: Text('CRM')), NavigationRailDestination(icon: Icon(Icons.inventory_2_outlined), selectedIcon: Icon(Icons.inventory_2), label: Text('Catalog')), NavigationRailDestination(icon: Icon(Icons.factory_outlined), selectedIcon: Icon(Icons.factory), label: Text('Operations')), NavigationRailDestination(icon: Icon(Icons.admin_panel_settings_outlined), selectedIcon: Icon(Icons.admin_panel_settings), label: Text('Manage'))]
        : const [NavigationRailDestination(icon: Icon(Icons.factory_outlined), selectedIcon: Icon(Icons.factory), label: Text('Operations'))];
    final requestedIndex = location.startsWith('/enterprise') ? 1 : location.startsWith('/events') ? 2 : location.startsWith('/orders') ? 3 : location.startsWith('/crm') ? 4 : location.startsWith('/catalog') ? 5 : location.startsWith('/operations') ? 6 : location.startsWith('/management') ? 7 : 0;
